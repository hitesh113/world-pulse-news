  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back Face */}
        <div
          className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-primary flex flex-col items-center justify-center p-2 border border-primary/50"
          style={{ backfaceVisibility: "hidden", transform: "rotateY(180deg)" }}
        >
          <div className="text-center">
            <p className="text-[8px] font-bold text-primary-foreground uppercase tracking-widest mb-1">Read</p>
            <p className="text-xs font-medium text-primary-foreground">Article</p>
          </div>
        </div>
      </motion.div>
    </motion.div>
...
export default function ScrollMorphHero({ articles }: ScrollMorphHeroProps) {
  ...
  const images = useMemo(() => 
    articles.slice(0, 20).map(article => article.cover_image_url || "/placeholder.svg"), 
  [articles]);
  ...
  return (
    <div ref={containerRef} className="relative w-full h-[600px] md:h-[800px] bg-background overflow-hidden rounded-lg">
      <div className="flex h-full w-full flex-col items-center justify-center" style={{ perspective: "1000px" }}>
        ...
        >
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-lg leading-relaxed">
            Scroll through our curated global headlines. Discover stories shaping tomorrow.
          </p>
        </motion.div>
