    ...
    queryFn: async () => {
      ...
      const mockArticles: Article[] = [
        ...
        },
        {
          ...
          cover_image_url: "https://images.unsplash.com/photo-1521412644187-c49fa049e84d?auto=format&fit=crop&w=1200&q=80",
        ...
        },
        {
          ...
          cover_image_url: "https://images.unsplash.com/photo-1518609878373-06d740f60d8b?auto=format&fit=crop&w=1200&q=80",
        ...
        },
        {
          ...
          cover_image_url: "https://images.unsplash.com/photo-1529341336622-f8e9d3c69d96?auto=format&fit=crop&w=1200&q=80",
      ...
      try {
        ...
        return [
          ...
          },
          {
            ...
            cover_image_url: "https://images.unsplash.com/photo-1521412644187-c49fa049e84d?auto=format&fit=crop&w=1200&q=80",
            excerpt: "In a stunning upset, the underdog team defeats the heavily favored champions in dramatic fashion.",
            body: "The football world was shaken as the unexpected champions lifted the prestigious Champions League trophy.",
            status: "published",
            published_at: new Date().toISOString(),
            created_at: new Date().toISOString(),
            source: "manual"
          },
          {
            ...
            cover_image_url: "https://images.unsplash.com/photo-1518609878373-06d740f60d8b?auto=format&fit=crop&w=1200&q=80",
            excerpt: "Major indices hit record highs as positive economic indicators boost investor confidence.",
            body: "Global stock markets experienced a significant rally today following the release of stronger-than-expected economic data.",
            status: "published",
            published_at: new Date().toISOString(),
            created_at: new Date().toISOString(),
            source: "manual"
